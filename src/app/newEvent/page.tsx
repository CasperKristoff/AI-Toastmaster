...
import StepperProgress from "./components/sections/StepperProgress";
...
function SectionTabs({
  ...
  const handleStepChange = (stepId: string) => {
    ...
    setActiveTab(stepId as TabType["id"]);
  };

  return (
    <div className="w-full flex flex-col items-center">
      <StepperProgress
        steps={tabs.map((tab) => ({ id: tab.id, label: tab.label }))}
    ...
    <div className="min-h-screen bg-gradient-to-br from-deep-sea/5 via-white to-kimchi/5">
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white/50 backdrop-blur-xl rounded-2xl p-8 border border-dark-royalty/10 w-full max-w-none">
          {activeTab === "overview" && event && <Overview event={event} />}
            ...
            >
              <EventProgram
                ...
                handleEditSegment={(id: string) => {
                  // For inline editing of regular segments
