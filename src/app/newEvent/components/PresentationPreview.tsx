...
export default function PresentationPreview({ event }: PresentationPreviewProps) {
          ...
          <div className="h-full flex flex-col items-center justify-center p-8 relative">
            ...
            <div className="absolute inset-0 bg-black/10 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
              <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 text-center">
                <p className="text-sm text-dark-royalty font-medium">Preview Mode</p>
                <p className="text-xs text-deep-sea/60">Slides auto-advance every 3 seconds</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white/50 backdrop-blur-xl rounded-2xl p-6 border border-dark-royalty/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          ...
          <div>
            ...
            <span className="ml-2 font-medium text-dark-royalty">{getEventTypeLabel(event.type)}</span>
          </div>
          <div>
            <span className="text-deep-sea/60">Tone:</span>
            <span className="ml-2 font-medium text-dark-royalty">{getToneLabel(event.tone)}</span>
          </div>
        </div>
        <div className="mt-4 p-4 bg-deep-sea/10 rounded-xl">
          <p className="text-sm text-deep-sea/70">
            💡 <strong>Tip:</strong> Use arrow keys or spacebar to navigate during the presentation. 
            Press &apos;N&apos; to toggle presenter notes, and &apos;R&apos; to reveal fun fact answers.
          </p>
        </div>
      </div>
    </div>
