...
const AddSegmentModal: React.FC<AddSegmentModalProps> = ({
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLDivElement>) => {
    // Prevent Enter in textarea from submitting
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onKeyDown={handleKeyDown} tabIndex={-1}>
