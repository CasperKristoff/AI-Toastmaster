    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <nav className="relative z-10 w-full bg-white/70 backdrop-blur-xl border-b border-gray-200/50 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center relative">
          ...
          />
          <span className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent cursor-pointer hover:scale-105 transition-transform duration-200 hover:from-indigo-700 hover:to-purple-700" onClick={() => router.push('/login')}>
            AI Toastmaster
          </span>
        </div>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center max-w-4xl mx-auto px-6 py-12">
        ...
        {/* Content Card */}
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-10 shadow-2xl border border-gray-200/50 hover:shadow-3xl hover:scale-105 hover:bg-white/90 transition-all duration-500 max-w-2xl cursor-pointer group" onClick={() => router.push('/login')}>
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-700 leading-relaxed font-medium group-hover:text-gray-800 transition-colors duration-300">
              Plan, host, and entertain with AI-generated content, games, and real-time event flow.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-8">
              <div className="flex items-center space-x-2 bg-gradient-to-r from-indigo-50 to-purple-50 px-4 py-2 rounded-full group-hover:from-indigo-100 group-hover:to-purple-100 transition-all duration-300">
                ...
                <span className="text-sm font-medium text-gray-700 group-hover:text-gray-800 transition-colors duration-300">AI-Generated Content</span>
              </div>
              <div className="flex items-center space-x-2 bg-gradient-to-r from-purple-50 to-pink-50 px-4 py-2 rounded-full group-hover:from-purple-100 group-hover:to-pink-100 transition-all duration-300">
                ...
                <span className="text-sm font-medium text-gray-700 group-hover:text-gray-800 transition-colors duration-300">Interactive Games</span>
              </div>
              <div className="flex items-center space-x-2 bg-gradient-to-r from-pink-50 to-red-50 px-4 py-2 rounded-full group-hover:from-pink-100 group-hover:to-red-100 transition-all duration-300">
                ...
                <span className="text-sm font-medium text-gray-700 group-hover:text-gray-800 transition-colors duration-300">Real-time Flow</span>
              </div>
            </div>
          </div>
        </div>
